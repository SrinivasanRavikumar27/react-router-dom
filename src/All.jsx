...
<div className='card' >
<img src="/src/assets/full-stack-web-development.jpg" className="card-img-top "  style={height} alt="..."/>
      <div class="card-body">
...
<div className='card'>
<img src="/src/assets/dataScience.jpg" className="card-img-top" style={height} alt="..."/>
      <div class="card-body">
...
<div className='card'>
<img src="/src/assets/cyberSecurity.jpg" className="card-img-top" style={height} alt="..."/>
      <div class="card-body">
