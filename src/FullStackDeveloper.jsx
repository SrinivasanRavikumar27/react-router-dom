...
function FullStackDeveloper() {
  ...
  return (
    ...
    <div className='card'>
    <img src="/src/assets/front-end-development.jpg" className="card-img-top" style={height} alt="..."/>
          <div class="card-body">
    ...
    <div className='card'>
    <img src="/src/assets/backend-development.png" className="card-img-top" style={height} alt="..."/>
          <div class="card-body">
    ...
    <div className='card'>
    <img src="/src/assets/database.png" className="card-img-top" style={height} alt="..."/>
          <div class="card-body">
